...
public partial class MainWindow : Window
{
    ...
    {
        var beispielDatenbank = System.IO.Path.Combine(AppContext.BaseDirectory, "Beispielbank.accdb");
    ...
    private void BerechnungAusDatenbankAnzeigen(string pfadZurDatenbank)
    {
        try
        {
            ...
            var periodenIDs = Datenbank.PeriodenIDs
            ...
            var aktuellePeriodeID = periodenIDs[^1];
            var ergebnis = new Zinsüberschuss(
